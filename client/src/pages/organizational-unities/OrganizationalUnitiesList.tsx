import {
  ...
  const OrganizationalUnitiesList: React.FC = () => {
    ...
    const { organizationalUnities, loading, error } = useAppSelector(
    ...
    const [selectedOrganizationalUnity, setSelectedOrganizationalUnity] = useState<OrganizationalUnityData | null>(
      null
    );
    ...
    const loadOrganizationalUnities = () => {
      dispatch(fetchOrganizationalUnities())
        .unwrap()
        .catch((error) => {
    ...
    const filteredOrganizationalUnities = organizationalUnities.filter((organizationalUnity) => {
            ...
            <IonCard style={{ width: "90%", maxWidth: "45rem" }}>
              ...
              <IonCardContent>
                ...
                {loading ? (
                  ...
                  <IonList>
                    {filteredOrganizationalUnities.map((organizationalUnity: OrganizationalUnityData) => (
                ...
                {!loading && !error && organizationalUnities.length > 0 && (
                  <div className="text-center mt-3">
                    <p>Total de unidades organizacionais: {organizationalUnities.length}</p>
                  </div>
                )}
              </IonCardContent>
            </IonCard>
