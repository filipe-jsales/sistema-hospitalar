...
const ResponsiblesList: React.FC = () => {
  ...
  const { responsibles, loading, error, pagination } = useAppSelector(
  ...
  const [selectedResponsible, setSelectedResponsible] =
    useState<ResponsibleData | null>(null);
            ...
            <IonCardContent>
              ...
              {!loading && !error && pagination && (
                <div className="text-center mt-3">
                  <p>
                    Exibindo {responsibles.length} de {pagination.totalItems}{" "}
                    responsáveis
